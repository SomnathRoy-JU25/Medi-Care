...
class Symptom extends Component {
  ...
  showContent = () => {
    ...
    return (
      <div id="#Symptoms" className="grid-row width-full gap-4 p-4 ">
        <div className="col-12 tablet:grid-col-5">
          {/* <div className="grid-row"> */}
          <input
            class="usa-input searchSymptomsInput form-input w-full p-2 border border-gray-300 rounded 
            bg-slate-800"
        ...
        col-span-5 flex justify-start mt-4">
