    ...
    <div className="max-w-screen-2xl container mx-auto fixed top-0 left-0 right-0 transition-all duration-300 ease-in-out bg-primaryBG shadow-md bg-base-100 text-black">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          <span>
            <a href="/">
              <img className="h-20 w-30 shadow-2xl rounded-full" src={logo} alt="" />
            </a>
          </span>
        </div>
        <div className="hidden grow items-start lg:flex">
          ...
          <div className="px-4">
            <button
              type="button"
              className="rounded-full bg-green-100 px-3 py-2 text-sm font-semibold text-black hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black hover:text-clip "
            >
