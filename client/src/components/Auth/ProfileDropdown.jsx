  ...
  return (
    <button className="relative" onClick={() => setOpen(true)}>
      <div className="flex items-center gap-x-1">
        ...
        />
        <AiOutlineCaretDown className="text-sm text-[#111827]" />
      </div>
      {open && (
        <div
        ...
        >
          ...
          <div
            ...
            className="flex w-full items-center gap-x-1 py-[10px] px-[12px] text-sm text-[#111827] hover:bg-[#6B7280] hover:text-[#F3F4F6]"
          >
