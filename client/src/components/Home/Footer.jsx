        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-2">
            <a href="#">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400 text-white bg-blue shadow-lg">
              <GiHealthNormal />
              </div>
                <span className="ml-4 text-lg font-bold">MediCare</span>
              </div>
            </a>
          </div>
